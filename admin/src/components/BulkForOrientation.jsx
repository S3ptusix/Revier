...
import { bulkForOrientation } from "../services/interviewServices";
import { formatShortDateTime } from "../utils/format";

export default function BulkForOrientation({
    applicantIds,
    onClose = () => { },
    loadAfter = () => { },
}) {
    ...
    const handleSubmit = async () => {
        ...
        try {
            const { success, message } = await bulkForOrientation(selectedOrientation.id, { applicantIds });
