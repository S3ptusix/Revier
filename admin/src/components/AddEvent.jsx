...
// so scheduling, rescheduling, and orientation all read as one flow.
const STEP_COPY = {
    1: { title: "Create Orientation Event", subtitle: "Set orientation details for this event" },
    2: { title: "Compose the Note", subtitle: "Answer a few quick prompts and we'll draft the note for you." },
    3: { title: "Preview Orientation Message", subtitle: "Review and edit the message before creating" }
};
            ...
            <Modal>
                ...
                <ModalBody>
                    ...
                    {step === 1 && (
                        <InfoList
                            infoList={[
                                "Set the orientation's schedule, mode, and location",
                                "Build a clear, professional message for attendees",
                                "Preview everything before the event is created",
                            ]}
                        />
                    )}
                ...
                <ModalFooter
                    submitLabel={
                        step < 1 ? "Next" : isSubmitting ? "Creating..." : "Confirm & Create"
                    }
                    cancelLabel="Preview"
                    onSubmit={
                        step === 1
